...
export const STACK_ITEMS = [
  ...
  { id: "langchain",  name: "LangChain",  ring: 1, angle: 0,   status: "completed",
    description: "Cadenas, agentes y herramientas para construir sobre LLMs." },
  { id: "langgraph",  name: "LangGraph",  ring: 1, angle: 72,  status: "completed",
    description: "Agentes con estado y flujos multi-step complejos." },
  { id: "anthropic",  name: "Claude",     ring: 1, angle: 144, status: "completed",
    description: "La API de Anthropic para agentes con tool use y razonamiento. Mi LLM de referencia ahora mismo." },
  { id: "openai",     name: "OpenAI API", ring: 1, angle: 216, status: "completed",
    description: "GPT-4, embeddings, function calling y fine-tuning." },
  { id: "fastapi",    name: "FastAPI",    ring: 1, angle: 288, status: "completed",
  ...
  { id: "docker",   name: "Docker",     ring: 2, angle: 240, status: "completed",
  ...
  { id: "mlflow",  name: "MLflow",     ring: 3, angle: 90,  status: "completed",
    description: "Tracking de experimentos, versionado y registro de modelos en producción." },
  { id: "azure",   name: "Azure",      ring: 3, angle: 210, status: "completed",
    description: "La nube donde despliego los sistemas de IA: servicios gestionados, Databricks y CI/CD." },
